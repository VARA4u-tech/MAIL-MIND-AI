      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-xl border border-primary/30 bg-background p-8 md:p-12 shadow-[0_0_50px_-12px_rgba(255,0,0,0.2)]"
          >
            <button
              onClick={onClose}
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div className="flex flex-col">
                <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-primary/50">Security Advisory</span>
                <span className="font-display text-xl uppercase tracking-widest text-primary">Authentication Notice</span>
              </div>
            </div>

            <div className="space-y-6 font-mono text-xs leading-relaxed text-primary/70">
              ...
              <div className="bg-primary/5 border-l-2 border-primary p-5 space-y-3">
                <p className="text-primary font-bold uppercase tracking-widest text-[10px]">To continue securely:</p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <button
                onClick={onProceed}
                className="flex-1 font-mono text-[11px] uppercase tracking-[0.2em] bg-primary text-background px-6 py-4 hover:bg-primary/90 transition-all flex items-center justify-center gap-2 group cursor-pointer"
              >
                Accept & Proceed to Sign-in
                <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>
              <button
                onClick={onClose}
                className="font-mono text-[11px] uppercase tracking-[0.2em] border border-primary/20 text-primary/60 px-6 py-4 hover:border-primary hover:text-primary transition-all cursor-pointer"
              >
                Cancel
              </button>
            </div>
